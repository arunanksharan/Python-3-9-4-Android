...
abs_srcdir=	/data/data/com.termux/files/home/Python-3.9.4
abs_builddir=	/data/data/com.termux/files/home/Python-3.9.4
...
# This goes into $(exec_prefix)
LIBPL=		$(prefix)/lib/python3.9/config-$(VERSION)$(ABIFLAGS)
